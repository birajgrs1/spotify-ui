  ...
  return (
    <div className="w-[25%] h-full flex-col p-2 hidden lg:flex">
      <div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around">
        ...
        <div className="flex items-center gap-3 pl-8 cursor-pointer">
          <img src={assets.search_icon} alt="Search Icon" className="w-[24px]" />
          <p className="font-bold">Search</p>
        </div>
      </div>

      <div className="bg-[#121212] h-[85%] rounded mt-[10px]">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-[36px] h-[36px] flex items-center justify-center rounded-full hover:bg-[#2b2b2b]">
              <img src={assets.plus_icon} alt="Plus Icon" className="w-5 cursor-pointer" />
            </div>
          </div>
        </div>
